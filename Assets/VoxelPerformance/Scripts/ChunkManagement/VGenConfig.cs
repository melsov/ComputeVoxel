...
namespace Mel.VoxelGen
{
    ...
    public struct VoxelGenDataMirror
    {
        ...
        {
            if (obj is VoxelGenDataMirror)
            {
                return Equal((VoxelGenDataMirror)obj);
            }
            return false;
        }
        ...
        public static bool operator ==(VoxelGenDataMirror a, VoxelGenDataMirror b) => a.Equal(b);
        public static bool operator !=(VoxelGenDataMirror a, VoxelGenDataMirror b) => !a.Equal(b);


        public override int GetHashCode()
        {
            return 774663759 + voxel.GetHashCode();
        }
    }
    ...
    public class VGenConfig : MonoBehaviour {
        ...
        public IntVector2 ColumnFootprint {
            get {
                return new IntVector2 { x = ChunkSizeX, y = ChunkSizeZ };
            }
        }
        ...
        public static readonly int VoxelMapDataBitMask = 0xFF;
        public static readonly int VoxelMapDataBitSize = 8;
        public static int VoxelsPerMapData { get { return 32 / VoxelMapDataBitSize; } }
        ...
        public static int SizeOfHLSLInt => 32;
        public int SizeOfExistsMap {
            get { return VoxelsPerChunk / SizeOfHLSLInt; }
        }
        public int SizeOfExistsMap27 => SizeOfExistsMap * 27;
        #endregion
        ...
        public int NumLODLevels { get { return ChunkGenData.LODLevels; } }
        [SerializeField]
        ...
        {
            None, Ramp, OneInACorner, WallX0, Sphere2C, Empty, Filled
        }
        ...
        [SerializeField] bool AlwaysTryToReadSerializedChunks = true;
        public bool IsSerializedDataValid {
            get {
                return AlwaysTryToReadSerializedChunks || PlayerPrefs.GetInt("SerDataValid") == 1;
            }
            set {
        ...
        [SerializeField] bool OnlyComputeInGenerator = true;
        [SerializeField] public bool ChunkDomainShouldDoNothing = false;
        [SerializeField] public bool RegenerateAllChunks = false;


        public static bool ComputeInChunkDomain = false;

        public bool DebugDontComputeChunksInDisplayPipeline {
            get { return OnlyComputeInGenerator || (DebugDontComputeChunksIfSerDataValid && IsSerializedDataValid); }
        }
        ...
        public uint EmptyVoxel { get { return 0; } }

        public static int DecodeVoxelType(uint packedVoxel)
        {
            return ((int)packedVoxel >> 24) & 0xFF;
        }

        public static int DecodeMapGenType(uint packedVoxel, int yPos)
        {
            // Voxels are packed low y to high y <-> MSB side to LSB side
            return ((int)packedVoxel >> ((VoxelsPerMapData - 1 - yPos % VoxelsPerMapData) * VoxelMapDataBitSize)) & VoxelMapDataBitMask;
        }

        public static IntVector3 ToMapGenIndex(IntVector3 vPos)
        {
            vPos.y /= VoxelsPerMapData;
            return vPos;
        }

        public IntVector3 MapGenArraySize {
            get { return new IntVector3(ChunkSizeX, MapDataDimY, ChunkSizeZ); }
        }
