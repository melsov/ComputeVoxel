...
namespace Mel.Util
{
    public static class ColorUtil
    {
        ...
        //static GradientColorKey[] RoygbivColorKeys()
        //{
        //    GradientColorKey[] keys = new GradientColorKey[roygbiv.Length];
        //    for(int i=0; i<keys.Length; ++i)
        //    {
        //        keys[i] = new GradientColorKey(roygbiv[i], i / (float)keys.Length);
        //    }
        //    return keys;
        //}
