...
namespace g3
{
    public struct Box2f
    {
        ...
        public Vector2f halfSize { get { return size / 2f; } }
        public Vector2f center { get { return min + halfSize; } }
        ...
        public Box2f scaledFromCenter(float scale)
        {
            return new Box2f()
            {
        ...
        public float heightOverWidth { get { return size.y / size.x; } }
        ...
        public override string ToString() {
            return string.Format("Box2f: min: {0} max: {1}", min.ToString(), max.ToString());
        }
    }
}
